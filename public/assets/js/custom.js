(function($) {
	...
	/*--LTR Leftmenu Versions --*/
	$('#myonoffswitch20').click(function () {    
		if (this.checked) {
			$('body').addClass('default-leftmenu');
			$('body').removeClass('closed-leftmenu');
			localStorage.setItem("default-leftmenu", "True");
			$("head link#sidemenu").attr("href", $(this));
			(document.getElementById("sidemenu").setAttribute("href", "../../assets/css/sidemenu.css"))
		}
		else {
	...
	$('#myonoffswitch21').click(function () {    
		if (this.checked) {
			...
			$("head link#sidemenu").attr("href", $(this));
			(document.getElementById("sidemenu").setAttribute("href", "../../assets/css/closed-sidemenu.css"))
		}
		else {
			$('body').removeClass('closed-leftmenu');
	...
	$('#myonoffswitch22').click(function () {    
		if (this.checked) {
			...
			localStorage.setItem("default-leftmenu", "True");
			$("head link#sidemenu").attr("href", $(this));
			(document.getElementById("sidemenu").setAttribute("href", "../../assets/css-rtl/sidemenu.css"))
		}
		else {
			$('body').removeClass('default-leftmenu');
			localStorage.setItem("default-leftmenu", "false");
	...
	$('#myonoffswitch23').click(function () {    
		if (this.checked) {
			...
			localStorage.setItem("closed-leftmenu", "True");
			$("head link#sidemenu").attr("href", $(this));
			(document.getElementById("sidemenu").setAttribute("href", "../../assets/css-rtl/closed-sidemenu.css"))
		}
		else {
			$('body').removeClass('closed-leftmenu');
			localStorage.setItem("closed-leftmenu", "false");
