(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_auth_permissions_Permissions_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/auth/permissions/Permissions.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/auth/permissions/Permissions.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _assets_js_jquery_3_4_1_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../assets/js/jquery-3.4.1.min.js */ "./public/assets/js/jquery-3.4.1.min.js");
/* harmony import */ var _assets_js_jquery_3_4_1_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_assets_js_jquery_3_4_1_min_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _assets_plugins_datatable_css_dataTables_bootstrap5_min_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../assets/plugins/datatable/css/dataTables.bootstrap5.min.css */ "./public/assets/plugins/datatable/css/dataTables.bootstrap5.min.css");
/* harmony import */ var _assets_plugins_datatable_css_responsive_dataTables_min_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../assets/plugins/datatable/css/responsive.dataTables.min.css */ "./public/assets/plugins/datatable/css/responsive.dataTables.min.css");
/* harmony import */ var _assets_plugins_datatable_css_buttons_dataTables_min_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../assets/plugins/datatable/css/buttons.dataTables.min.css */ "./public/assets/plugins/datatable/css/buttons.dataTables.min.css");
/* harmony import */ var _assets_plugins_datatable_js_jquery_dataTables_min_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../assets/plugins/datatable/js/jquery.dataTables.min.js */ "./public/assets/plugins/datatable/js/jquery.dataTables.min.js");
/* harmony import */ var _assets_plugins_datatable_js_jquery_dataTables_min_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_assets_plugins_datatable_js_jquery_dataTables_min_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _assets_plugins_datatable_js_dataTables_bootstrap5_min_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../assets/plugins/datatable/js/dataTables.bootstrap5.min.js */ "./public/assets/plugins/datatable/js/dataTables.bootstrap5.min.js");
/* harmony import */ var _assets_plugins_datatable_js_dataTables_bootstrap5_min_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_assets_plugins_datatable_js_dataTables_bootstrap5_min_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _assets_plugins_datatable_dataTables_responsive_min_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../assets/plugins/datatable/dataTables.responsive.min.js */ "./public/assets/plugins/datatable/dataTables.responsive.min.js");
/* harmony import */ var _assets_plugins_datatable_dataTables_responsive_min_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_assets_plugins_datatable_dataTables_responsive_min_js__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _assets_plugins_datatable_js_dataTables_buttons_min_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../../assets/plugins/datatable/js/dataTables.buttons.min.js */ "./public/assets/plugins/datatable/js/dataTables.buttons.min.js");
/* harmony import */ var _assets_plugins_datatable_js_dataTables_buttons_min_js__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_assets_plugins_datatable_js_dataTables_buttons_min_js__WEBPACK_IMPORTED_MODULE_9__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              axios.get('/api/auth/components?list=1').then(function (response) {
                _this.componentsList = response.data.data;
                ...
                _this.datatable = $('#datatable').DataTable({
                  ...
                  columns: [{
                    ...
                    render: function render(data, type, row) {
                      return _mixins__WEBPACK_IMPORTED_MODULE_1__.formFieldsMixin.methods.getStatus(row.status);
                    }
                  }, {
                    data: 'actions',
                    name: 'actions',
              ...
              _this.modal = new bootstrap.Modal(document.getElementById('editElementModal'), {
                keyboard: false
              });
              _this.modal2 = new bootstrap.Modal(document.getElementById('optionElementModal'), {
                keyboard: false
              });
  ...
  methods: {
    setUserPermission: function setUserPermission(user) {
      if (this.optionForm.users.includes(user)) this.optionForm.users.splice(this.optionForm.users.indexOf(user), 1);else this.optionForm.users.push(user);
    },
    handleComponents: function handleComponents(component) {
      var _this2 = this;
      ...
      if (!this.form.components.includes(component)) {
        ...
        this.$refs.modules.forEach(function (element) {
          ...
          if (moduleComponent == component) {
            if (_this2.form.modules.includes(module)) _this2.form.modules.splice(_this2.form.modules.indexOf(module), 1);

            _.remove(_this2.form.permissions, function (n) {
    ...
    setFormSaved: function setFormSaved() {
      var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      this.formSaved = value;
      this.formValidated = false;
    },
    handleEditPermission: function handleEditPermission(e) {
      var _this3 = this;

      e.preventDefault();
      this.setFormSaved(false);
      this.clearFormErrors(); // form valdiation using JQuery

      axios.put("/api/auth/permissions/".concat(this.form.id), this.form).then(function (response) {
        if (response.status) {
          _this3.setFormSaved();

          swal("Succès!", "Les données du groupe de permissions a été mise à jour.", "success").then(function (value) {
            _this3.modal.hide();
          }); // update dt

          _this3.datatable.ajax.reload();
        }
      })["catch"](function (error) {
        if (error.response.status != 422) {
          console.log(error);

          _this3.formErrors.push('Echoué!, Une erreur est survenue.');
        } else {
          for (var _i = 0, _Object$entries = Object.entries(error.response.data.errors); _i < _Object$entries.length; _i++) {
            ...
            for (var _key in value) {
              if (Object.hasOwnProperty.call(value, _key)) _this3.formErrors.push(value[_key]);
            }
          }
        }
    ...
    handleUsersPermission: function handleUsersPermission(e) {
      var _this4 = this;

      e.preventDefault();
      this.clearFormErrors(); // form valdiation using JQuery

      axios.post("/api/auth/permissions/".concat(this.optionForm.id, "/users"), this.optionForm).then(function (response) {
        if (response.status) {
          swal("Succès!", "Les données du groupe de permissions a été mise à jour.", "success").then(function (value) {
            _this4.modal2.hide();
          });
        ...
        if (error.response.status != 422) {
          ...
          _this4.formErrors.push('Echoué!, Une erreur est survenue.');
        } else {
          for (var _i2 = 0, _Object$entries2 = Object.entries(error.response.data.errors); _i2 < _Object$entries2.length; _i2++) {
            ...
            for (var _key2 in value) {
              if (Object.hasOwnProperty.call(value, _key2)) _this4.formErrors.push(value[_key2]);
            }
          }
        }
      }); // scroll to request msg
    ...
    dtActions: function dtActions() {
      ...
      $('.table').on('click', '.btn-edit', function (e) {
        ...
        axios.get("/api/auth/permissions/".concat(elementID)).then(function (response) {
          // fill form attributes
          for (var _i3 = 0, _Object$entries3 = Object.entries(response.data.data); _i3 < _Object$entries3.length; _i3++) {
          ...
          if (response.data.data.hasOwnProperty('rules') && response.data.data.rules) response.data.data.rules.forEach(function (element) {
            ...
            JSON.parse(element.permissions).forEach(function (p) {
      ...
      $('.table').on('click', '.btn-users', function (e) {
        ...
        axios.get("/api/auth/permissions/".concat(vdata.optionForm.id, "/users")).then(function (response) {
          vdata.optionForm.users = response.data;

          if (!vdata.usersList.length) {
            axios.get('/api/auth/users?list=1').then(function (response) {
      ...
      $('#editElementModal').on('hidden.bs.modal', function (event) {
        refs.modules.forEach(function (element) {
          element.checked = false;
        });
        refs.components.forEach(function (element) {
          element.checked = false;
        });
      });
      ...
      $('.table').on('click', '.btn-delete', function (e) {
        ...
        swal({
          ...
          if (willDelete) {
            axios["delete"]("/api/auth/permissions/".concat(elementID)).then(function (response) {
              if (response.status === 204) {
                swal("Succès!", "Elément sélectionné a été supprimé.", "success");
                dt.ajax.reload();
              } else if (response.status === 409) swal("Attention!", "Impossible de supprimer l'élément sélectionné à cause des données associées.", "warning");else swal("Échoué!", "Echec de supprimer l'élément sélectionné car vous n'avez pas la permission ou l'élément n'existe pas.", "error");
            });
          }
        });
      });
...
(function (b) {
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"), __webpack_require__(/*! datatables.net */ "./node_modules/datatables.net/js/jquery.dataTables.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (k) {
...
/***/ "./public/assets/plugins/datatable/js/dataTables.bootstrap5.min.js":
/*!*************************************************************************!*\
  !*** ./public/assets/plugins/datatable/js/dataTables.bootstrap5.min.js ***!
  \*************************************************************************/
/***/ (function(module, exports, __webpack_require__) {
...
(function (e) {
  ...
  e.extend(t.prototype, {
    ...
    remove: function remove(a) {
      ...
      if (b.buttons.length) for (var f = b.buttons.length - 1; 0 <= f; f--) {
    ...
    _expandButton: function _expandButton(a, b, c, d) {
      var f = this.s.dt,
          h = 0;
  ...
  t.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      return h.name;
        ...
        f = function f(h) {
      if (Array.isArray(h)) for (var m = 0, g = h.length; m < g; m++) {
        f(h[m]);
  ...
  t.buttonSelector = function (a, b) {
    for (var c = [], d = function d(g, n, k) {
      for (var p, l, v = 0, u = n.length; v < u; v++) {
        if (p = n[v]) l = k !== r ? k + v : v + "", g.push({
          node: p.node,
          name: p.conf.name,
          idx: l
      ...
      if (Array.isArray(g) || g instanceof e) for (l = 0, k = g.length; l < k; l++) {
        f(g[l], n);
      } else if (null === g || g === r || "*" === g) for (l = 0, k = p.length; l < k; l++) {
        c.push({
          inst: n,
          node: p[l].node
        });
        ...
        if (-1 !== g.indexOf(",")) for (p = g.split(","), l = 0, k = p.length; l < k; l++) {
          f(p[l].trim(), n);
        ...
        });else if (-1 !== g.indexOf(":name")) for (g = g.replace(":name", ""), l = 0, k = p.length; l < k; l++) {
          p[l].name === g && c.push({
            inst: n,
            node: p[l].node
          });
      ...
      } else "object" === _typeof(g) && g.nodeName && (p = e.inArray(g, l), -1 !== p && c.push({
        inst: n,
        node: l[p]
      }));
      ...
      return {
        ...
        buttons: e.map(b, function (h, m) {
          return {
            ...
            action: function action(g, n) {
              n.page.len(h).draw();
            },
            init: function init(g, n, k) {
              var p = this;
            ...
            destroy: function destroy(g, n, k) {
              g.off("length.dt" + k.namespace);
            }
          };
        }),
        init: function init(h, m, g) {
          var n = this;
          h.on("length.dt" + g.namespace, function () {
            n.text(g.text);
          });
        },
        destroy: function destroy(h, m, g) {
  ...
  var D = function D(a) {
    ...
    var c = e.extend(!0, {}, {
      ...
      trim: !0,
      format: {
        header: function header(u) {
          return t.stripData(u, c);
        },
        footer: function footer(u) {
          return t.stripData(u, c);
        },
        body: function body(u) {
          return t.stripData(u, c);
        }
      },
      customizeData: null
...
$jscomp.getGlobal = function (k) {
  k = ["object" == (typeof globalThis === "undefined" ? "undefined" : _typeof(globalThis)) && globalThis, k, "object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window, "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self, "object" == (typeof __webpack_require__.g === "undefined" ? "undefined" : _typeof(__webpack_require__.g)) && __webpack_require__.g];
...
(function (k) {
  ...
  function va(a, b, c, d) {
    ...
    if ("dom" !== c && (c && "auto" !== c || "dom" !== e.src)) {
      var h = e.anCells;
      if (h) if (d !== q) g(h[d], d);else for (c = 0, f = h.length; c < f; c++) {
        g(h[c], c);
      }
  ...
  function ab(a, b, c, d) {
    ...
    if (f) for (; f;) {
      ...
      f = f.nextSibling;
    } else for (e = b.anCells, f = 0, v = e.length; f < v; f++) {
      t(e[f]);
    }
  ...
  function xa(a, b, c) {
    ...
    if (b) {
      ...
      for (d = f.length; l < d; l++) {
        if (a = f[l].nTr) for (; e = a.firstChild;) {
          a.removeChild(e);
        }
        e = 0;
  ...
  function Ib(a) {
    ...
    for (var f = a.sDom.split(""), g, h, l, n, m, p, t = 0; t < f.length; t++) {
      ...
      if ("<" == h) {
        ...
        e.append(l);
        e = k(l);
      } else if (">" == h) e = e.parent();else if ("l" == h && d.bPaginate && d.bLengthChange) g = Jb(a);else if ("f" == h && d.bFilter) g = Kb(a);else if ("r" == h && d.bProcessing) g = Lb(a);else if ("t" == h) g = Mb(a);else if ("i" == h && d.bInfo) g = Nb(a);else if ("p" == h && d.bPaginate) g = Ob(a);else if (0 !== u.ext.feature.length) for (l = u.ext.feature, p = 0, n = l.length; p < n; p++) {
        if (h == l[p].cFeature) {
          g = l[p].fnInit(a);
          break;
        }
  ...
  function Ya(a) {
    ...
    if (d || !t && !f && !e && h == na(a) && h == n.length) for (v = 0; v < h; v++) {
      ...
      for (v = 0; v < l.length; v++) {
        r = c[l[v]], n[v].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig ? K(r.sWidthOrig) : "", r.sWidthOrig && f && k(n[v]).append(k("<div/>").css({
          width: r.sWidthOrig,
          margin: 0,
          padding: 0,
          border: 0,
      ...
      for (v = e = 0; v < l.length; v++) {
        p = k(n[v]), g = p.outerWidth() - p.width(), p = x.bBounding ? Math.ceil(n[v].getBoundingClientRect().width) : p.outerWidth(), e += p, c[l[v]].sWidth = K(p - g);
      }
    ...
    b = function b(h) {
      if (h && h.time) {
        ...
        if (-1 === k.inArray(!1, l) && (l = a.iStateDuration, !(0 < l && h.time < +new Date() - 1E3 * l || h.columns && f.length !== h.columns.length))) {
          ...
          if (h.columns) for (d = 0, e = h.columns.length; d < e; d++) {
            l = h.columns[d], l.visible !== q && (f[d].bVisible = l.visible), l.search !== q && k.extend(a.aoPreSearchCols[d], Wb(l.search));
          }
  ...
  var u = function u(a) {
    ...
    this.each(function () {
      ...
      if ("table" != this.nodeName.toLowerCase()) ca(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);else {
        ...
        if (null === g.aoColumns) for (t = [], h = 0, l = f.length; h < l; h++) {
          t.push(null);
        } else t = g.aoColumns;
        h = 0;
  ...
  var xc = function xc(a, b, c, d) {
    ...
    0 < T(c, "_details").length && (b.on("draw.dt.DT_details", function (d, e) {
      ...
      if (a === e) for (e = na(e), f = 0, g = c.length; f < g; f++) {
...
/***/ "./resources/js/views/auth/permissions/Permissions.vue":
/*!*************************************************************!*\
  !*** ./resources/js/views/auth/permissions/Permissions.vue ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Permissions_vue_vue_type_template_id_5f92d51e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Permissions.vue?vue&type=template&id=5f92d51e& */ "./resources/js/views/auth/permissions/Permissions.vue?vue&type=template&id=5f92d51e&");
/* harmony import */ var _Permissions_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Permissions.vue?vue&type=script&lang=js& */ "./resources/js/views/auth/permissions/Permissions.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _Permissions_vue_vue_type_template_id_5f92d51e___WEBPACK_IMPORTED_MODULE_0__.render,
  _Permissions_vue_vue_type_template_id_5f92d51e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/auth/permissions/Permissions.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/views/auth/permissions/Permissions.vue?vue&type=script&lang=js&":
/*!**************************************************************************************!*\
  !*** ./resources/js/views/auth/permissions/Permissions.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/views/auth/permissions/Permissions.vue?vue&type=template&id=5f92d51e&":
/*!********************************************************************************************!*\
  !*** ./resources/js/views/auth/permissions/Permissions.vue?vue&type=template&id=5f92d51e& ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Permissions_vue_vue_type_template_id_5f92d51e___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Permissions_vue_vue_type_template_id_5f92d51e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Permissions_vue_vue_type_template_id_5f92d51e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Permissions.vue?vue&type=template&id=5f92d51e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/auth/permissions/Permissions.vue?vue&type=template&id=5f92d51e&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/auth/permissions/Permissions.vue?vue&type=template&id=5f92d51e&":
/*!***********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/auth/permissions/Permissions.vue?vue&type=template&id=5f92d51e& ***!
  \***********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            [
              _c("div", { staticClass: "modal-dialog" }, [
                _c("div", { staticClass: "modal-content" }, [
                  _c("div", {
                    staticClass: "card-status bg-brand br-tr-7 br-tl-7"
                  }),
                  _vm._v(" "),
                  _vm._m(1),
                  _vm._v(" "),
                  _c("div", { staticClass: "modal-body" }, [
                    ...
                    _c(
                      "form",
                      {
                        attrs: { id: "editElementForm" },
                        on: {
                          submit: function($event) {
                            $event.preventDefault()
                            return _vm.handleEditPermission.apply(
                              null,
                              arguments
                            )
                          }
                                ...
                                _vm._l(_vm.componentsList, function(item) {
                                  return _c("div", { key: item.index }, [
                                    _c(
                                      ...
                                      {
                                        staticClass:
                                          "list-group-item list-module"
                                      },
                                      [
                                        _c(
                                          "span",
                                          { staticClass: "tag tag-gray" },
                                    ...
                                    _vm._v(" "),
                                    _vm.form.components.includes(item.id)
                                      ? _c(
                                          "li",
                                          {
                                            staticClass:
                                          ...
                                          [
                                            item.modules.length
                                              ...
                                              : _c("span", [
                                                  _vm._v(
                                                    "Il n'y a pas de modules dans cet applicatif"
                                                  )
                                                ])
                                          ]
                                        )
                ...
                _c("div", { staticClass: "modal-content" }, [
                  ...
                  _c("div", { staticClass: "modal-body" }, [
                    ...
                    _c(
                      "form",
                      {
                        attrs: { id: "optionElementForm" },
                        on: {
                          submit: function($event) {
                            $event.preventDefault()
                            return _vm.handleUsersPermission.apply(
                              null,
                              arguments
                            )
                          }
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._l(_vm.usersList, function(item) {
                              return _c(
                                "label",
                                { key: item.index, staticClass: "me-2" },
                                [
                                  _c("span", { staticClass: "tag" }, [
                                    ...
                                    _c(
                                      "span",
                                      {
                                        ...
                                        class: [
                                          _vm.optionForm.users.includes(item.id)
                                            ? "tag-success"
                                            : "tag-light-gray"
                                        ],
                                        on: {
                                          click: function($event) {
                                            return _vm.setUserPermission(
                                              item.id
                                            )
                                          }
                                        }
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c(
        "h5",
        { staticClass: "modal-title", attrs: { id: "editElementModalLabel" } },
        [
          _c("i", { staticClass: "fe fe-edit-3" }),
          _vm._v(" Modifier groupe de permissions")
        ]
      ),
      _vm._v(" "),
      _c(
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("label", { staticClass: "form-label" }, [
      _vm._v("Applicatifs (modules et permissions) "),
      _c("small", { staticClass: "text-danger" }, [_vm._v("*")])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "row mt-5" }, [
      _c(
        "div",
        { staticClass: "col-md btn-toolbar justify-content-end btn-group" },
        [
          _c(
            "button",
            {
            ...
            [
              _c("i", { staticClass: "fe fe-arrow-left me-2" }),
              _vm._v(" Annuler")
            ]
          ),
          _vm._v(" "),
          _c(
            "button",
            {
              staticClass: "btn btn-radius btn-brand",
              attrs: { type: "submit" }
            },
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c(
        "h5",
        { staticClass: "modal-title", attrs: { id: "optionlementModalLabel" } },
        [
          _c("i", { staticClass: "fe fe-users" }),
          _vm._v(" Affecter des utilisateurs à groupe de permissions")
        ]
      ),
      _vm._v(" "),
      _c(
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", { staticClass: "form-label mb-3" }, [
      _vm._v("Sélectionner Le(s) Utilisateur(s) "),
      _c("small", { staticClass: "text-danger" }, [_vm._v("*")])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "table-responsive" }, [
      _c(
        ...
        [
          _c("thead", [
            _c("tr", [
              _c("th", { staticClass: "wd-15p" }, [_vm._v("Libellé")]),
              _vm._v(" "),
